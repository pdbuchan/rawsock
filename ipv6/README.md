**<ins>IPv6 introduces the need for Neighbor Discovery</ins>**<br/><br/>
...
If we wish to have the ability to change any parameter in the IPv6 header, we need to have the source and destination MAC addresses available (more explanation). Before trying neighbor discovery, you can take a quick look at a couple of examples where we don't use neighbor discovery, and thus can only change the hop limit and traffic class values in the IPv6 header.<br/><br/>
